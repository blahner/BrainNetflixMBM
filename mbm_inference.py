...
import tqdm
from dataset import bmd_group41_dataset
...
def main(args):
    ...
    dataset_test = bmd_group41_dataset(dataset_path=args.dataset_path, roi_list=args.roi_list, patch_size=config.patch_size,
